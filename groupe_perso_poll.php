...
$deleted_ids = [];
$delRes = $mysqli->query("SELECT id FROM groupe_utilisateurs_messages WHERE groupe_id = " . (int) $groupe_id . " AND deleted_for_everyone_at IS NOT NULL AND deleted_for_everyone_at > (NOW() - INTERVAL 20 SECOND)");
