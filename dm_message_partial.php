<?php
// Partial de rendu d'une bulle de message privé. Réutilise les mêmes classes CSS que la
// messagerie interne (messagerie-msg, messagerie-att-*...) pour un rendu visuel identique.
...
<div class="messagerie-msg <?php echo $is_own ? 'is-own' : 'is-other'; ?>" data-id="<?php echo (int) $msg['id']; ?>">
    ...
    <div class="messagerie-msg-body">
        <div class="messagerie-msg-bubble-row">
            ...
            <button type="button" class="messagerie-msg-options-btn" data-is-own="<?php echo $is_own ? '1' : '0'; ?>" data-can-delete-everyone="<?php echo $is_own ? '1' : '0'; ?>" title="<?php echo t('messagerie_options'); ?>"><i class="fas fa-ellipsis-vertical"></i></button>
        </div>
